...
import { readStdin, parsePayload, isSystemNotification, detectLeaving, listLadders, ownedBy, createStateDir, rungCommand, rungShell, emit } from './lib.mjs'
...
const leaving = !notification && detectLeaving(prompt)
